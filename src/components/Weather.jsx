...
const Weather = (props) => {
  ...
  return (
    <div className="min-h-[60vh] p-8 flex flex-col justify-center space-y-8">
      <div className="min-h-[30vh] flex flex-col justify-center items-start space-y-8">
      ...
      <div className="min-h-[20vh] flex items-center justify-between">
